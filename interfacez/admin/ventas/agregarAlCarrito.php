...
$sentencia = $conexion->prepare("SELECT *,(SELECT nombre from usuarios,productos WHERE documento = coach AND codigo = '$codigo') AS nomvendedor FROM productos WHERE codigo = ? AND coach = '$doc' LIMIT 1;");
