...
?>
	...
	<div class="col-xs-12 contenedor1">
		...
		<form method="post" action="guardarDatosEditados.php">
			...
			<input value="<?php echo $producto->existencia ?>" class="form-control" name="existencia" required readonly type="number" id="existencia" placeholder="Cantidad o existencia">
