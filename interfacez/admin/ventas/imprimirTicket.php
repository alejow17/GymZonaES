...
$sentencia = $conexion->prepare("SELECT id, fecha, total FROM ventas WHERE id = ?");
...
$sentenciaProductos = $conexion->prepare("SELECT p.codigo, p.descripcion,p.precioVenta, pv.cantidad
FROM productos p
INNER JOIN 
