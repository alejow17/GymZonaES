...
if (!isset($_POST["codigo"]) || !isset($_POST["descripcion"]) || !isset($_POST["precioVenta"]) || !isset($_POST["existencia"])) {
    exit();
}
...
try {
    ...
    if ($e->getCode() == 23000) {
        echo "Por favor, utiliza otro código. El código ingresado ya existe.";
    } else {
