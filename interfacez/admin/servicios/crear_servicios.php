...
<body>
    <div class="form-container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                <input type="text" title="Debe contener de 6 a 12 digitos" autocomplete="off" placeholder="Precio" class="form-control" pattern=".{6,12}" onkeyup="numeros(this),espacios(this)" maxlength="12" id="nombre" name="precio" required>
            </div>
            <br><br>
