...
<?php 
    if ((isset($_POST["btn_actualizar"])))
    {
        ...
        $consulta3 = $conexion -> prepare ("UPDATE usuarios SET nombre='$nombre', usuario='$usuario', id_roles='$rol' WHERE documento='$documento'");
        $consulta3->execute();
...
<body>
    <div class="container contenedor1">
        ...
        <br>
        <h1 class="titulo" style="font-size: 45px; margin-bottom: 10px;" >ACTUALIZAR USUARIOS</h1><br>
        <form method="post">
        <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><input required maxlength="20" pattern="{0,30}" name="usuario" value="<?php echo $consul1['usuario']?>"></td>
                            <td>
                            <select name="roles">
                                    <option value="<?php echo $consul1['id_roles'] ?>"><?php echo $consul1['roles'] ?></option>
                                        <?php
