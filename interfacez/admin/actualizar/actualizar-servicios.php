    ...
    <div class="container contenedor1">
        ...
        <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><input name="descripcion" value="<?php echo $consul1['desc_servicio']?>" ></td>
                            <td style="text-align: center;"><input maxlength="30" pattern="{0,30}" name="precio" value="<?php echo $consul1['precio']?>"></td>
                            <td>
