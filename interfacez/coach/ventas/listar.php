...
$sentencia = $conexion->query("SELECT *,(SELECT nombre from usuarios WHERE documento = coach AND documento = '$doc') AS nomvendedor FROM productos WHERE coach = '$doc' LIMIT $offset, $entriesPerPage");
...
<body>
	<nav class="navega">
		...
		<ul class="nav nav-tabs justify-content-center">
			<li class="nav-item">
				<a class="nav-link text-light p-3" aria-current="page" href="../index-coach.php"><b>MENU</b></a>
			</li>
			<li class="nav-item">
				<a class="nav-link text-light p-3 dropdown-toggle" href="../listar/listar-usuarios.php"><b>USUARIOS</b></a>
			</li>
			<li class="nav-item">
				<a class="nav-link active text-bg-warning p-3" href="../ventas/listar.php"><b style="color: white;">PRODUCTOS</b></a>
			</li>
			<li class="nav-item">
	...
	<div class="col-xs-12 contenedor1">
		...
		<form method="post">
			<h1>PRODUCTOS</h1>
			<a class="btn btn-success" style="margin-right: 830px;" href="./nuevo-producto.php">Crear producto<i class="fa fa-plus"></i></a>
			<a class="btn btn-primary" href="listar-codigos-barras.php">Codigos de barras<i class="fa fa-plus"></i></a>
		</form>
		<br>
		<table class="table table-bordered">
			...
			<tbody>
				...
				?>
					<tr>
						<td><?php echo $producto->nomvendedor ?></td>
						<td><?php echo $producto->codigo ?></td>
						<td><?php echo $producto->descripcion ?></td>
						<td><?php echo $producto->precioVenta ?></td>
						<td><?php echo $producto->existencia ?></td>
						<td><a class="btn btn-warning" href="<?php echo "editar.php?id=" . $producto->id ?>"><img style="width:30px;" src="../../../iconos/pencil.png" alt="borrar"></a></td>
						<td><a class="btn btn-danger" onclick="return confirm('Quiere eliminar <?php echo $producto->descripcion ?>?')" href="<?php echo "eliminar.php?id=" . $producto->id ?>"><img style="width:30px;" src="../../../iconos/delete.png" alt="borrar"></a></td>
					</tr>
				<?php } ?>
			</tbody>
		</table>
