...
<body>
    <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="6" step="0.01" autocomplete="off" placeholder="Estatura" value="<?php echo $resul->estatura ?>" class="form-control" onkeyup="numeros(this)" name="estatura" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Pecho</label>
                <input type="text"  maxlength="6" step="0.01" autocomplete="off" placeholder="Pecho" value="<?php echo $resul->pecho ?>" class="form-control" onkeyup="numeros(this)" name="pecho" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Cintura</label>
                <input type="text"  maxlength="6" step="0.01" autocomplete="off" placeholder="Cintura" value="<?php echo $resul->cintura; ?>" class="form-control" onkeyup="numeros(this)" name="cintura" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Cadera</label>
                <input type="text"  maxlength="6" step="0.01" autocomplete="off" placeholder="Cadera" value="<?php echo $resul->cadera; ?>" class="form-control" onkeyup="numeros(this)" name="cadera" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Brazo izquierdo</label>
                <input type="text"  onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Brazo Izquierdo" value="<?php echo $resul->brazo_izquierdo; ?>" class="form-control" name="brazo_izquierdo" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Brazo derecho</label>
                <input type="text" onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Brazo Derecho" value="<?php echo $resul->brazo_derecho; ?>" class="form-control" name="brazo_derecho" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Peso</label>
                <input type="text"  onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Peso" value="<?php echo $resul->peso; ?>" class="form-control" name="peso" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">B.M.I</label>
                <input type="text"  onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="BMI" value="<?php echo $resul->bmi; ?>" class="form-control" name="bmi" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Grasa</label>
                <input type="text" onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Grasa" value="<?php echo $resul->grasa; ?>" class="form-control" name="grasa" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Musculo</label>
                <input type="text" onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Músculo" value="<?php echo $resul->musculo; ?>" class="form-control" name="musculo" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Agua</label>
                <input type="text"  onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Agua" value="<?php echo $resul->agua; ?>" class="form-control" name="agua" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Grava V</label>
                <input type="text" onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Grasa Visceral" value="<?php echo $resul->grasa_v; ?>" class="form-control" name="grasa_v" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Hueso</label>
                <input type="text" onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Hueso" value="<?php echo $resul->hueso; ?>" class="form-control" name="hueso" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Metabolismo</label>
                <input type="text" onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Metabolismo" value="<?php echo $resul->metabolismo; ?>" class="form-control" name="metabolismo" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Proteina</label>
                <input type="text" onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Proteina" value="<?php echo $resul->proteina; ?>" class="form-control" name="proteina" required>
            </div><br>
            <div class="form-group">
				<label for="formGroupExampleInput" style="color: #fff;" class="form-label">Obesidad</label>
                <input type="text" onkeyup="numeros(this)" maxlength="6" step="0.01" autocomplete="off" placeholder="Obesidad" value="<?php echo $resul->obesidad; ?>" class="form-control" name="obesidad" required>
            </div><br>
