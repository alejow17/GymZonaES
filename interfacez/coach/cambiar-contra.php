...
<body>
    <div class="form-container">
        ...
        <form method="POST" name="form1" id="form1" autocomplete="off">
            ...
            <input type="password" style="height:35px;" pattern=".{6,12}" maxlength="12" onkeyup="espacios(this)" class="contra" name="contra1" id="cont" placeholder="Nueva clave"><br><br>
            <input type="password" style="height:35px;" pattern=".{6,12}" maxlength="12" onkeyup="espacios(this)" class="contra" name="contra2" id="conta" placeholder="Confirme clave"><br><br>
