...
<body>
        ...
        <ul class="nav nav-tabs justify-content-center">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="../listar/listar-usuarios.php">Lista de clientes</a></li>
    ...
    <div class="container contenedor1">
        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr style="text-align: center;">
                    ...
                    <td style="text-align: center;"><?= $cons['nacimiento'] ?></td>
                    <td>
                        <form action="../actualizar/actualizar-cliente.php" method="get">
                            <input type="hidden" name="actualizar" value="<?= $cons['documento'] ?>">
                            <button class="btn btn-warning botones" type="submit"><img style="width:30px;" src="../../../iconos/pencil.png" alt="rulers"></button>
                        </form>
                    </td>
                </tr>
            <?php
        ...
        <div class="container text-center">
            <?php
            $totalEntries = $conexion->query("SELECT COUNT(*) FROM usuarios INNER JOIN roles ON usuarios.id_roles=roles.id_roles WHERE usuarios.id_roles=3")->fetchColumn();
