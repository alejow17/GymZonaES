    ...
    <div class="form-container">
        ...
        <form method="post">
            <div class="form-group">
                <input type="hidden" readonly autocomplete="off" value="<?php echo $_SESSION['document'] ?>" class="form-control" name="coach" readonly>
            </div>
            ...
            <br>
            <div class="form-group">
                <select class="form-select" name="doc_client">
