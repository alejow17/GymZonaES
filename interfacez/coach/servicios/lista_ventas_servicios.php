...
$consulta = $conexion->prepare("SELECT (SELECT nombre FROM usuarios WHERE documento = coach AND venta_serv.id_serv = servicios.id_servicio) AS nombre_coach, fecha, desc_servicio, doc_client, nombre, precio FROM venta_serv, servicios, usuarios WHERE doc_client = documento AND venta_serv.id_serv = servicios.id_servicio AND coach = '$documento'");
$consulta->execute();
...
<body>
    <nav class="navega">
        ...
        <ul class="nav nav-tabs justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link active text-bg-warning p-3" href="../servicios/lista_ventas_servicios.php"><b  style="color: white" >SERVICIOS</b></a>
            </li>
            <li class="nav-item">
    ...
    <div class="container contenedor1">
        ...
        <form method="post"> 
            ...
            <a style="float: right;" class="btn btn-primary" href="lista-servicios.php" role="button">Servicios actuales</a>
        </form>
        <br>
