    ...
    <div class="container contenedor1">
        ...
        <form method="post">
            <table class="table table-bordered">
                ...
                <tr style="text-align: center;">
                    <td style="text-align: center;"><input name="doc" value="<?php echo $consul1['documento'] ?>"
                            readonly></td>
                    <td style="text-align: center;"><input onkeyup="letras(this)" maxlength="20" pattern="{0,30}"
                            name="nombre" required value="<?php echo $consul1['nombre'] ?>"></td>
                    <td>
...
<script>
    ...
    function letras(e){
  e.value = e.value.replace(/[^A-Za-z ]+/g, function(match) {
    return match.trim().length > 0 ? ' ' : match.trim();
  });
}
</script>
