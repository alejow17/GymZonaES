...
<?php 
    if ((isset($_POST["btn-registrar"])))
    {
        ...
        {
            $consulta3 = $conexion -> prepare ("INSERT INTO usuarios (documento, nombre, nacimiento, usuario, password, id_roles) VALUES ('$documento','$nombre', '$nacimiento','$usuario','$hash','$rol')");
            $consulta3->execute();
...
<body onload="limitarFechas()" >
    <div class="form-container">
        ...
        <form method="post" >
            ...
            <div class="form-group">
                <input type="text" autocomplete="off" placeholder="Nombre" class="form-control" pattern="[a-zA-Z ]+" onkeyup="minuscula(this),soloLetras(this)" maxlength="50" id="nombre" name="nombre" required><br>
            </div>
...
<script>
    ...
    fechaMaxima.setFullYear(fechaMaxima.getFullYear() - 5); // Restar un año
    var fechaMinima = new Date();
    fechaMinima.setFullYear(fechaMinima.getFullYear() - 100); // Restar 120 años
